...
namespace Route24.GameOff
{
    public class ShipController : MonoBehaviour
    {
        ...
        public void MoveToExit()
        {
            ...
            AudioTestManager.Instance.PlaySFX("SHIP_APPROVED");
        }
        ...
        public void Sink()
        {
            ...
            AudioTestManager.Instance.PlaySFX("SHIP_SINK");
        }
        ...
        public void Decline()
        {
            ...
            AudioTestManager.Instance.PlaySFX("SHIP_DECLINED");
        }
        ...
        private void OnExited()
        {
            ...
            AudioTestManager.Instance.PlaySFX("SHIP_EXIT");
        }
